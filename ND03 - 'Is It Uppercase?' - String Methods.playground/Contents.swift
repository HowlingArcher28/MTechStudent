...
func returnObject(input: String) -> Bool {
    return input == input.uppercased()
}
var testNumberOne: String = "Is all uppercased: \(returnObject(input: "THIS IS ALL UPPERCASED"))"
    print(testNumberOne)
var testNumberTwo: String = "Is all uppercased: \(returnObject(input: "tHiS iS aLl UpPeRcAsEd"))"
    print(testNumberTwo)
