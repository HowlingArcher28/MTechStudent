...
//print("The value of foo is \(foo)")
//Because its trying to print outside of the scope. the scope being the curly brackets
...
//X is defined as a global scope. but the x value is being mutated by adding 1 to X
...
greeting(greeting: "", name: "Sara")
greeting(greeting: "Welcome", name: "Jeff")
