 ...
 */
let userImputAge: String = "34"
let usrAge: Int? = Int(userImputAge)
...
let correctInputAge: String = "34"
let correctUserAge: Int? = Int(correctInputAge)

print(correctUserAge) // Prints: Optional(34)
print(correctUserAge!) // Prints: 34

//:  Now use optional binding to unwrap `userAge`. If `userAge` has a value, print it to the console.

if let actualAge = correctUserAge {
    print("The user's age is \(actualAge).")
} else {
    print("The user's age could not be determined.")
}
...
print("Because no Int value was given")
