...
if let comp = validComputer {
    print("Valid Computer: \(comp.ram) GB RAM, manufactured in \(comp.yearManufactured)")
} else {
    print("ValidComputer is nil")
}

if let comp = invalidComputer {
    print("Invalid Computer: \(comp.ram) GB RAM, manufactured in \(comp.yearManufactured)")
} else {
