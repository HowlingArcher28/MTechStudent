...
// Function to get a Meal for a meal name
func mealFor(_ mealName: String) -> Meal? {
    return meals[mealName]
}

// Example calls
if let breakfast = mealFor("Breakfast") {
    print("Breakfast: \(breakfast.food), Calories: \(breakfast.calories)")
} else {
    print("No breakfast logged.")
}

if let lunch = mealFor("Lunch") {
...
let savedMealLog = retrieveMealLog()
print(savedMealLog)
